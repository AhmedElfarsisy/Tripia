...
public class TripsRepo {
    ...
    public TripsRepo(){
        ...
        tripsList.add(new Trip(1, "Go for gym", "Madinat nasr", "Smart gym", "04 Dec 2021 08:30 PM", "https://images.unsplash.com/photo-1563857256304-d943ffb54ca8?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80"));
